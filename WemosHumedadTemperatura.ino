...
void constrolSensorHumedad() {
  
  tiempo2 = millis();
  if(tiempo2 > (tiempo1+2000)){  //Si ha pasado 2 segundo ejecuta el IF
    tiempo1 = millis(); //Actualiza el tiempo actual
    
    client.publish("mike/5625/humedad1/data", "Hola desde wemos");
